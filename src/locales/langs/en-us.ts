const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'function_hide-child_one': 'Hide Child One',
    ...
    'energy-analysis_comprehensive': 'Comprehensive',
    'energy-analysis_comprehensive_daily': 'Daily',
    'energy-analysis_comprehensive_monthly': 'Monthly',
    'energy-analysis_comprehensive_statistics': 'Statistics',
    'energy-analysis_comprehensive_year': 'Yearly',
    'energy-indicators': 'Indicators',
    analysis: 'Analysis',
    ...
    costmanagement_electricity: 'Electricity Cost',
    costmanagement_tactics: 'Tactics',
    costmanagement_trend: 'Trend',
    // Saving
    saving: 'Saving',
    saving_program: 'Program',
    ...
    carbonemission_calculate: 'Calculate',
    // Statistical
    statistical: 'Statistical',
    statistical_cost: 'Cost',
    statistical_flow: 'Flow',
    'statistical_yoy-mom': 'YoY MoM',
    // Other Analysis
    benchmark: 'Benchmark',
    ...
    itemized: 'Itemized',
    itemizedenergyanalysis: 'Itemized Analysis',
    keyequipment: 'Key Equipment',
    keyequipment_daily: 'Daily',
    keyequipment_monthly: 'Monthly',
    keyequipment_year: 'Yearly',
    peakvalley: 'Peak Valley',
    'peakvalley-analysis': 'Peak Valley Analysis',
    processenergy: 'Process Energy',
    productoutput: 'Product Output',
    spikesandvalleys: 'Peaks Valleys',
    'process-energy': 'Process Energy',
    'process-energy_statistics': 'Statistics',
    'process-energy_statistics_daily': 'Daily',
    'process-energy_statistics_monthly': 'Monthly',
    'process-energy_statistics_year': 'Yearly'
  },
  page: {
    login: {
      common: {
