...
<template>
  <ElCard class="card-wrapper">
    <ElForm :model="model" label-width="100px" inline>
      <ElFormItem label="计量点编码">
        <ElInput v-model="model.code" placeholder="请输入编码" clearable class="w-180px" />
      </ElFormItem>
      <ElFormItem label="计量点名称">
        <ElInput v-model="model.name" placeholder="请输入名称" clearable class="w-180px" />
      </ElFormItem>
      <ElFormItem label="类型">
        <ElSelect v-model="model.type" placeholder="请选择类型" clearable class="w-180px">
      ...
      <ElFormItem label="能源介质">
        <ElSelect v-model="model.mediumId" placeholder="请选择介质" clearable class="w-180px">
          <ElOption v-for="item in allMediums" :key="item.id" :label="item.mediumName" :value="item.id" />
        </ElSelect>
      </ElFormItem>
      <ElFormItem label="状态">
        <ElSelect v-model="model.status" placeholder="请选择状态" clearable class="w-180px">
