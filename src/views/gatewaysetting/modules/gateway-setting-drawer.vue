...
import { fetchCreateGatewaySetting, fetchUpdateGatewaySetting, fetchGatewaySettingById } from '@/service/api/gatewaysetting';
  ...
  <ElDrawer v-model="drawerVisible" :title="title" size="500px">
    <ElForm ref="formRef" :model="formData" :rules="rules" label-width="100px">
      ...
      <ElFormItem label="心跳时间" prop="hbtTime">
        <ElDatePicker v-model="formData.hbtTime" type="datetime" placeholder="选择心跳时间" class="w-full" value-format="YYYY-MM-DD HH:mm:ss" />
      </ElFormItem>
